...
OutFile "决战岩浆岛_v1.1_Windows_FullInstall.exe"
...
Section "MainSection" SEC01
  ...
  CreateDirectory "$SMPROGRAMS\决战岩浆岛v1.1"
  CreateShortCut "$SMPROGRAMS\决战岩浆岛v1.1\决战岩浆岛.lnk" "$INSTDIR\jzyjd.exe"
  CreateShortCut "$SMPROGRAMS\决战岩浆岛v1.1\卸载.lnk" "$INSTDIR\uninst.exe"
...
Section Uninstall
  ...
  Delete "$SMPROGRAMS\决战岩浆岛v1.1\Uninstall.lnk"
  Delete "$DESKTOP\决战岩浆岛.lnk"
  Delete "$SMPROGRAMS\决战岩浆岛v1.1\决战岩浆岛.lnk"

  RMDir "$SMPROGRAMS\决战岩浆岛v1.1"
